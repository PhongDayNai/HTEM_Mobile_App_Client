...
import com.watb.htem.BuffetOrderResponse
import com.watb.htem.Dish
import com.watb.htem.DishesOrderRequest
import com.watb.htem.DishesOrderResponse
import com.watb.htem.GuessBuffetOrderRequest
import com.watb.htem.LoginRequest
import com.watb.htem.LoginResponse
import com.watb.htem.PaymentGuessRequest
import com.watb.htem.PaymentGuessResponse
import com.watb.htem.PaymentUserRequest
import com.watb.htem.PaymentUserResponse
import com.watb.htem.RegisterRequest
import com.watb.htem.UserBuffetOrderRequest
import com.watb.htem.UserPointsRequest
import com.watb.htem.UserPointsResponse
import com.watb.htem.UserTransactionRequest
import com.watb.htem.UserTransactionResponse
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    ...
                    responseBody?.let {
                        Log.d("Login", gson.fromJson(it, LoginResponse::class.java).toString())
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("Register", gson.fromJson(it, LoginResponse::class.java).toString())
                        gson.fromJson(it, LoginResponse::class.java)
                    }
                } else {
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("UserBuffOrder", gson.fromJson(it, BuffetOrderResponse::class.java).toString())
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("GuessBuffetOrder", gson.fromJson(it, BuffetOrderResponse::class.java).toString())
                        gson.fromJson(it, BuffetOrderResponse::class.java)
                    }
                } else {
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("DishesOrder", gson.fromJson(it, DishesOrderResponse::class.java).toString())
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("PaymentUser", gson.fromJson(it, PaymentUserResponse::class.java).toString())
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("PaymentGuess", gson.fromJson(it, PaymentGuessResponse::class.java).toString())
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("UserPoints", gson.fromJson(it, UserPointsResponse::class.java).toString())
        ...
        return withContext(Dispatchers.IO) {
            client.newCall(request).execute().use { response ->
                ...
                if (response.isSuccessful) {
                    val responseBody = response.body?.string()
                    responseBody?.let {
                        Log.d("UserTransaction", gson.fromJson(it, UserTransactionResponse::class.java).toString())
