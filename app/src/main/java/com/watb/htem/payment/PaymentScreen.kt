...
fun PaymentScreen(navController: NavHostController, tableCode: String) {
    ...
    val width = screenWidth * 0.9f // 90% chiều rộng màn hình
    val height = (width.value * 16 / 10).dp // Chiều cao tính theo tỉ lệ 16:10
    var totalBill = 0
    ...
    ConstraintLayout(
        ...
        val (userPointsRef, backgroundRef, billRef, buttonRef) = createRefs()
